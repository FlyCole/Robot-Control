...
res = vrep.simxGetObjectPosition(id, xyzSensor,armRef, vrep.simx_opmode_streaming); vrchk(vrep, res, true);
res = vrep.simxGetObjectOrientation(id, xyzSensor,armRef, vrep.simx_opmode_streaming); vrchk(vrep, res, true);
