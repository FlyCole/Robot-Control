function youbot_vision()
    ...
    can_y=[6.25,-0.75,-2.25,6.25,2.25];
    % define object location
    %[theta,obj_x,obj_y]=cal_pos();
    obj_x=[-3.167,-3.35,-3.75,-2.3784,-3.6272];
    obj_y=[-5.25,-5.3065,-6.09,-5.8816,-6.1455];
    ...
    while true
        ...
        elseif strcmp(fsm, 'extend')
            ...
            zbw=[0.001,0.001,0.001,0.002,0.001];
