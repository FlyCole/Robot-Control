function youbot_vision()
    ...
    obj_x=[-3.167,-3.2971,-3.75,-2.3776,-3.6259];
    obj_y=[-5.25,-5.3065,-6.09,-5.8992,-6.132];
    ...
    while true
        ...
        elseif strcmp(fsm, 'rotate2')
            ...
            if (abs(angdiff(angl, youbotEuler(3))) < .1 / 180 * pi) && ...
                ...
                rotVel = 0;
                if count==4;
                    vrep.simxSetObjectOrientation(id, h.rgbdCasing, h.ref, [0 0 pi*3/2], vrep.simx_opmode_oneshot);
                end
                fsm = 'snapshot';
            end
            prevOri = youbotEuler(3);
